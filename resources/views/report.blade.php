   ...
   <style>
       ...
       .dropdown-submenu {
        ...
        .dropdown-submenu:hover .dropdown-menu {
            display: block; /* แสดง submenu เมื่อ hover */
            left: 100%; /* ให้อยู่ทางขวาของเมนูหลัก */
            top: 0; /* แนวนอน */
        }

        .dropdown-menu {
            display: none; /* ปิดการแสดงผลโดยค่าเริ่มต้น */
        }
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarShop">
                        ...
                        <li class="dropdown-submenu">
                            <a class="dropdown-item" href="/reprt">แจ้งซ่อม</a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ route('repair.history') }}">ประวัติการแจ้งซ่อม</a></li>
                            </ul>
                        </li>
                        <li class="dropdown-submenu">
                            <a class="dropdown-item" href="#">จองช่าง</a>
                            <ul class="dropdown-menu">
